package ceneax.app.hongmiao.widget.SwipeRefreshLoadMore;
...
public class SwipeRefreshLoadMore extends ViewGroup implements NestedScrollingParent,
    ...
    private static final String LOG_TAG = SwipeRefreshLoadMore.class.getSimpleName();
    ...
    private Animation.AnimationListener mRefreshListenerBottom = new Animation.AnimationListener() {
        @Override
...
//                     (width / 2 + circleWidth / 2), childHeight/2 + circleHeight);
    ...
    /**
     * Set a callback to override {@link SwipeRefreshLoadMore#canChildScrollUp()} method. Non-null
    ...
    /**
     * Classes that wish to override {@link SwipeRefreshLoadMore#canChildScrollUp()} method
     * behavior should implement this interface.
     */
    public interface OnChildScrollUpCallback {
        /**
         * Callback that will be called when {@link SwipeRefreshLoadMore#canChildScrollUp()} method
         ...
         */
        boolean canChildScrollUp(SwipeRefreshLoadMore parent, @Nullable View child);
    }
