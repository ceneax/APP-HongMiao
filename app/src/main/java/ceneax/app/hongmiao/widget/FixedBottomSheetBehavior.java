package ceneax.app.hongmiao.widget;
...
public class FixedBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    private static final String TAG = "FixedBottomSheetBehavior";

    @FixedBottomSheetBehavior.SaveFlags
    ...
    private FixedBottomSheetBehavior.SettleRunnable settleRunnable = null;
    ...
    @NonNull private final ArrayList<FixedBottomSheetBehavior.BottomSheetCallback> callbacks = new ArrayList<>();
    ...
    public FixedBottomSheetBehavior(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        ...
        if (hasBackgroundTint) {
            // 这里报错，于是添加了注解：@SuppressLint("RestrictedApi")
    ...
    public Parcelable onSaveInstanceState(@NonNull CoordinatorLayout parent, @NonNull V child) {
        return new FixedBottomSheetBehavior.SavedState(super.onSaveInstanceState(parent, child), this);
    }

    @Override
    public void onRestoreInstanceState(
            @NonNull CoordinatorLayout parent, @NonNull V child, @NonNull Parcelable state) {
        FixedBottomSheetBehavior.SavedState ss = (FixedBottomSheetBehavior.SavedState) state;
    ...
    public boolean onLayoutChild(
        ...
        // 这里判断是否是viewPager，是的话就监听事件
        if(child instanceof ViewPager) {
            // 如果viewPager没有切换过，那么监听的事件就不会执行，所以需要初始化一个值
            nestedScrollingChildRef = new WeakReference<>(findScrollingChild(((ViewPager) child).getChildAt(((ViewPager) child).getCurrentItem())));

            // 开始监听
            ((ViewPager) child).addOnPageChangeListener(new ViewPager.SimpleOnPageChangeListener() {
                @Override
                public void onPageSelected(int position) {
                    super.onPageSelected(position);
                    nestedScrollingChildRef = new WeakReference<>(findScrollingChild(((ViewPager) child).getChildAt(position)));
                }
            });
        } else {
            // 不是viewPager的话就按照原来的代码执行
     ...
     */
    public void setSaveFlags(@FixedBottomSheetBehavior.SaveFlags int flags) {
     ...
     * @deprecated use {@link #addBottomSheetCallback(FixedBottomSheetBehavior.BottomSheetCallback)} and {@link
     *     #removeBottomSheetCallback(FixedBottomSheetBehavior.BottomSheetCallback)} instead
     */
    // 这特么，打印log内容太长，加了个注解
    @SuppressLint("LongLogTag")
    @Deprecated
    public void setBottomSheetCallback(FixedBottomSheetBehavior.BottomSheetCallback callback) {
        Log.w(
                TAG,
     ...
     * @param callback The callback to notify when bottom sheet events occur.
     */
    public void addBottomSheetCallback(@NonNull FixedBottomSheetBehavior.BottomSheetCallback callback) {
     ...
     */
    public void removeBottomSheetCallback(@NonNull FixedBottomSheetBehavior.BottomSheetCallback callback) {
     ...
     */
    public void setState(@FixedBottomSheetBehavior.State int state) {
        if (state == this.state) {
            return;
        }
        if (viewRef == null) {
    ...
    private void settleToStatePendingLayout(@FixedBottomSheetBehavior.State int state) {
    ...
    void setStateInternal(@FixedBottomSheetBehavior.State int state) {
        if (this.state == state) {
            return;
        }
        this.state = state;
    ...
    private void updateDrawableForTargetState(@FixedBottomSheetBehavior.State int state) {
        if (state == STATE_SETTLING) {
    ...
    private void restoreOptionalState(@NonNull FixedBottomSheetBehavior.SavedState ss) {
    ...
    void startSettlingAnimation(View child, int state, int top, boolean settleFromViewDragHelper) {
        ...
        if (startedSettling) {
            ...
            if (settleRunnable == null) {
                ...
                settleRunnable = new FixedBottomSheetBehavior.SettleRunnable(child, state);
            }
    ...
    private final ViewDragHelper.Callback dragCallback =
            new ViewDragHelper.Callback() {
                ...
                public void onViewReleased(@NonNull View releasedChild, float xvel, float yvel) {
                    int top;
                    @FixedBottomSheetBehavior.State int targetState;
                    if (yvel < 0) { // Moving up
                        if (fitToContents) {
                            top = fitToContentsOffset;
                            targetState = STATE_EXPANDED;
    ...
    private class SettleRunnable implements Runnable {
        ...
        SettleRunnable(View view, @FixedBottomSheetBehavior.State int targetState) {
            this.view = view;
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        public SavedState(Parcelable superState, @NonNull FixedBottomSheetBehavior<?> behavior) {
            super(superState);
        ...
        /**
         * This constructor does not respect flags: {@link FixedBottomSheetBehavior#SAVE_PEEK_HEIGHT}, {@link
         * FixedBottomSheetBehavior#SAVE_FIT_TO_CONTENTS}, {@link FixedBottomSheetBehavior#SAVE_HIDEABLE}, {@link
         * FixedBottomSheetBehavior#SAVE_SKIP_COLLAPSED}. It is as if {@link FixedBottomSheetBehavior#SAVE_NONE}
         * were set.
         *
         * @deprecated Use {@link FixedBottomSheetBehavior.SavedState (Parcelable, FixedBottomSheetBehavior )} instead.
         */
        @Deprecated
        ...
        public static final Creator<FixedBottomSheetBehavior.SavedState> CREATOR =
                new ClassLoaderCreator<FixedBottomSheetBehavior.SavedState>() {
                    @NonNull
                    @Override
                    public FixedBottomSheetBehavior.SavedState createFromParcel(@NonNull Parcel in, ClassLoader loader) {
                        return new FixedBottomSheetBehavior.SavedState(in, loader);
                    }

                    @Nullable
                    @Override
                    public FixedBottomSheetBehavior.SavedState createFromParcel(@NonNull Parcel in) {
                        return new FixedBottomSheetBehavior.SavedState(in, null);
                    }

                    @NonNull
                    @Override
                    public FixedBottomSheetBehavior.SavedState[] newArray(int size) {
                        return new FixedBottomSheetBehavior.SavedState[size];
                    }
                };
    }
    ...
    public static <V extends View> FixedBottomSheetBehavior<V> from(@NonNull V view) {
